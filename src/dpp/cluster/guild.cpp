...
void cluster::guild_auditlog_get(snowflake_t<guild> guild_id, snowflake_t<user> user_id, uint32_t action_type, snowflake_t<user> before, snowflake_t<user> after, uint32_t limit, command_completion_event_t callback) {
